...
class AnswerSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Answer::insert([
            ...
            //ex 1
            ["question_id" => "16", "hint" => "FEW", "value" => json_encode(["few programmes | were sold"]), "created_at" => now()],
            ["question_id" => 17, "hint" => "INSTEAD", "value" => json_encode(["instead of|taking/catching/getting"]), "created_at" => now()],
            ["question_id" => 18, "hint" => "NEVER", "value" => json_encode(["had/'d never|broken"]), "created_at" => now()],
            ["question_id" => 19, "hint" => "LOOK", "value" => json_encode(["would|look into/at"]), "created_at" => now()],
            ["question_id" => 20, "hint" => "BECAUSE", "value" => json_encode(["was/got postponed|because it rained"]), "created_at" => now()],
            ["question_id" => 21, "hint" => "CARRY", "value" => json_encode(["to carry on|working"]), "created_at" => now()],
            ...
            //ex 3
            ["question_id" => "28", "hint" => "BETTER", "value" => json_encode(["play tennis|better than he"]), "created_at" => now()],
            ["question_id" => "29", "hint" => "BOUGHT", "value" => json_encode(["are/us|(being) bought from"]), "created_at" => now()],
            ["question_id" => "30", "hint" => "PRAISED", "value" => json_encode(["was praised|by the coach"]), "created_at" => now()],
            ["question_id" => "31", "hint" => "TOUCH", "value" => json_encode(["to get|in touch with"]), "created_at" => now()],
            ["question_id" => "32", "hint" => "SALE", "value" => json_encode(["be|on/for sale before"]), "created_at" => now()],
            ["question_id" => "33", "hint" => "BEEN", "value" => json_encode(["if|it had not been"]), "created_at" => now()],


            //ex 4
            ["question_id" => "34", "hint" => "MUCH", "value" => json_encode(["how much|the trips"]), "created_at" => now()],
            ["question_id" => "35", "hint" => "COME", "value" => json_encode(["able to|come up with"]), "created_at" => now()],
            ["question_id" => "36", "hint" => "GIVE", "value" => json_encode(["to give|(careful) thought/consideration to"]), "created_at" => now()],
            ["question_id" => "37", "hint" => "EVEN", "value" => json_encode(["on (walking)|even when/though/after it"]), "created_at" => now()],
            ["question_id" => "38", "hint" => "HARDLY", "value" => json_encode(["hardly any tickets|left/remaining/(still) available"]), "created_at" => now()],
            ["question_id" => "39", "hint" => "CHANCE", "value" => json_encode(["a/any chance|of getting"]), "created_at" => now()],


            //ex 5
            ["question_id" => "40", "hint" => "REMEMBER", "value" => json_encode(["will always remember|going"]), "created_at" => now()],
            ["question_id" => "41", "hint" => "SHOULD", "value" => json_encode(["should not|have ridden"]), "created_at" => now()],
            ["question_id" => "42", "hint" => "WORTH", "value" => json_encode(["it wasn't|worth staying"]), "created_at" => now()],
            ["question_id" => "43", "hint" => "MIGHT", "value" => json_encode(["might have|hidden"]), "created_at" => now()],
            ["question_id" => "44", "hint" => "CARRIED", "value" => json_encode(["carried on|going up"]), "created_at" => now()],
            ["question_id" => "45", "hint" => "LIKELY", "value" => json_encode(["isn't likely|to improve"]), "created_at" => now()],
            ...
            ["question_id" => "61", "hint" => "WISH", "value" => json_encode(["wish I had|bought", "wish I'd|bought"]), "created_at" => now()],
            ["question_id" => "62", "hint" => "EVEN", "value" => json_encode(["even though|it was snowing"]), "created_at" => now()],
            ["question_id" => "63", "hint" => "SEEN", "value" => json_encode(["if\/whether|I'd seen","if\/whether|I had seen"]), "created_at" => now()],
            ["question_id" => "64", "hint" => "OWN", "value" => json_encode(["on|your own"]), "created_at" => now()],
            ["question_id" => "65", "hint" => "RUNG", "value" => json_encode(["would not have rung|if","wouldn't have rung|if"]), "created_at" => now()],
            ["question_id" => "66", "hint" => "HAD", "value" => json_encode(["you had|your computer repaired"]), "created_at" => now()],
            ["question_id" => "67", "hint" => "BEEN", "value" => json_encode(["must have been|surprised to"]), "created_at" => now()],
            ["question_id" => "68", "hint" => "HARDLY", "value" => json_encode(["it|hardly ever"]), "created_at" => now()],
            ["question_id" => "69", "hint" => "TAKES", "value" => json_encode(["it takes me|twenty minutes"]), "created_at" => now()],
            ["question_id" => "70", "hint" => "PREVENTED", "value" => json_encode(["prevented us (from)|going\/getting"]), "created_at" => now()],
            ["question_id" => "71", "hint" => "SOON", "value" => json_encode(["as soon as|you hear"]), "created_at" => now()],
            ["question_id" => "72", "hint" => "RATHER", "value" => json_encode(["'d rather|you didn't","would rather|you didn't","'d rather|you did not","would rather|you did not"]), "created_at" => now()],
            ["question_id" => "73", "hint" => "SUCCEED", "value" => json_encode(["succeed in|winning\/getting\/obtaining"]), "created_at" => now()],
            ["question_id" => "74", "hint" => "ANYBODY", "value" => json_encode(["there was hardly anybody|in\/at"]), "created_at" => now()],
            ["question_id" => "75", "hint" => "CARE", "value" => json_encode(["taking|care of"]), "created_at" => now()],
            ["question_id" => "76", "hint" => "SILLIEST", "value" => json_encode(["the silliest|I've ever","the silliest|I have ever"]), "created_at" => now()],
            ["question_id" => "77", "hint" => "FELT", "value" => json_encode(["(me) how|I felt about"]), "created_at" => now()],
            ["question_id" => "78", "hint" => "UNLIKELY", "value" => json_encode(["is unlikely|to go\/carry"]), "created_at" => now()],
            ["question_id" => "79", "hint" => "THOUGHT", "value" => json_encode(["is thought|to be"]), "created_at" => now()],
            ["question_id" => "80", "hint" => "BORROW", "value" => json_encode(["if\/whether|he could borrow"]), "created_at" => now()],
            ["question_id" => "81", "hint" => "MISSED", "value" => json_encode(["would have mised|the beginning\/start","would've missed|the beginning\/start"]), "created_at" => now()],
            ["question_id" => "82", "hint" => "WERE", "value" => json_encode(["were you I'd|make","were you I would|make"]), "created_at" => now()],
            ["question_id" => "83", "hint" => "RIDDEN", "value" => json_encode(["was (being) ridden|by"]), "created_at" => now()],
            ["question_id" => "84", "hint" => "WISH", "value" => json_encode(["wish I had not|gone","wish I hadn't|gone"]), "created_at" => now()],
            ["question_id" => "85", "hint" => "CASE", "value" => json_encode(["in case|we need\/have"]), "created_at" => now()],
            ["question_id" => "86", "hint" => "TOLD", "value" => json_encode(["told Jamie|not to be"]), "created_at" => now()],
            ["question_id" => "87", "hint" => "BEING", "value" => json_encode(["is being made|by"]), "created_at" => now()],
            ["question_id" => "88", "hint" => "WORSE", "value" => json_encode(["was worse|than we had","was worse|than we'd","was worse|than"]), "created_at" => now()],
            ["question_id" => "89", "hint" => "DIFFICULT", "value" => json_encode(["found it difficult|to print"]), "created_at" => now()],
            ["question_id" => "90", "hint" => "ALLOWED", "value" => json_encode(["we're not allowed|to","we are not allowed|to","we aren't allowed|to"]), "created_at" => now()],
        ]);
    }
}
