<div class="grid grid-cols-2 gap-8 justify-items-center items-start overflow-y-auto">
    <div
        class="place-self-center flex flex-col  max-w-sm h-72 w-72 bg-white rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
        <div class="my-auto items-center text-center">
            <div class="pb-2 justify-center flex">
    ...
    <div
        class="place-self-center flex flex-col items-center max-w-sm h-72 w-72 bg-white rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
        <div class="my-auto items-center text-center">
            <div class="pb-2 justify-center flex">
    ...
    <div
        ...
        <div class="my-auto items-center">
            ...
            <div class="pb-2 justify-center flex"><svg xmlns="http://www.w3.org/2000/svg" class="h-20 w-20"
                    viewBox="0 0 576 512">
                    <path fill="#B197FC"
