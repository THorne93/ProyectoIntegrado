                                        ...
                                        @foreach ($allUsers as $user)
                                            <li>
                                                <div
                                                    ...
                                                    <label wire:click="changeRecipient({{ $user->id }})"
                                                        class="w-full cursor-pointer py-2 ms-2 text-sm font-medium text-gray-900 rounded-sm dark:text-gray-300">{{$user->name . ' ' . $user->surname}}</label>
                                                </div>
                                            </li>
                                        @endforeach
