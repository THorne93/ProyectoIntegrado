                ...
                <div class="w-full">
                    <div class="max-h-48 overflow-y-auto scrollBarThin">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead
                                class="text-xs text-gray-700 uppercase bg-gray-200 dark:bg-gray-700 dark:text-gray-400 sticky top-0 z-10 border-b border-gray-300 dark:border-gray-600">
                                <tr>
                                                ...
                                                <div class="flex-1">
                                                    @if ($exercise->trashed())
                                                        <button wire:click='restore({{ $exercise->id }})'
                                                            class="w-full px-4 py-1 bg-gray-300 border border-gray-400 rounded hover:bg-blue-400 text-black transition-colors">
                                                            Restore
                                                        </button>
                                                    @else
