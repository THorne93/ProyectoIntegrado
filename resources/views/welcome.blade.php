    ...
    <div class="flex-grow flex items-center justify-center">
        <div class="flex flex-row  w-4/5 max-w-7xl m-4 gap-12   items-center justify-center">
            ...
            <div class="flex w-full bg-gray-100 border border-gray-400 rounded overflow-hidden">
                ...
                <!-- Column 1: Image -->
                <div class="w-3/5 p-2  h-full">
                    <img src="/storage/img/landingImg.JPG" alt="Landing Image" class="w-full rounded-md h-full object-cover" />
                </div>

                <!-- Column 2: Text -->
                <div class="w-2/5 bg-gray-100 flex flex-col items-center justify-center p-6">
