...
class DashboardPartThreeStats extends Component
{
    public function render()
    {
        ...
        $stats = DB::table('user_records')
            ...
            )->where('exercises.part', '=', '3')->where('users.id', '=', auth()->id())->orderBy('user_records.timestamp', 'DESC')  // Order by timestamp in descending order
            ->limit(10)
            ->get();


        return view('livewire.dashboard-part-three-stats')->with('stats', $stats);
    }
}
